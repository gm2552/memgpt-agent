        ...
        return retObjects.stream().map(ob -> {
            ...
            try {
                ...
                Class<? extends Message> messageClassType = switch(type) {
                    case SYSTEM -> MessageUtils.SystemWrapper.class;
                    case TOOL -> MessageUtils.ToolResponseWrapper.class;
                    case ASSISTANT -> MessageUtils.AssistantWrapper.class;
                    case USER -> MessageUtils.UserWrapper.class;
                };
